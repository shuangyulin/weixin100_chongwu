  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">宠物小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="店主账号" class="input" v-if="tableName=='dianzhu'">
			  <el-input v-model="ruleForm.dianzhuzhanghao" autocomplete="off" placeholder="店主账号" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='dianzhu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="店主姓名" class="input" v-if="tableName=='dianzhu'">
			  <el-input v-model="ruleForm.dianzhuxingming" autocomplete="off" placeholder="店主姓名" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='dianzhu'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='dianzhu'">
